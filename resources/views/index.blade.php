							...
							<div class="col-lg-7 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item submenu dropdown">
										...
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="{{route('frontend.blogpost')}}">Blog</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{route('frontend.singleblogpost')}}">Blog Details</a>
											</li>
										</ul>
									</li>
									<li class="nav-item submenu dropdown">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!-- Optional JavaScript  <script src="{{asset('front/js/theme.js')}}"></script>-->
	<!-- jQuery first, then Popper.js, then Bootstrap JS <script src="{{asset('front/vendors/flipclock/timer.js')}}"></script>-->
